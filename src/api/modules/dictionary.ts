...
import { DictionaryDetailListResp, DictionaryListResp, DiceDetail, DiceDetailReq } from '@/types/dictionary';
...
// ======================
// 获取字典详情列表
export const getSysDictionaryInfoList = (
  data: IProgressReq & { sysDictionaryID: number },
): Promise<IProgressResp<DictionaryDetailListResp>> => {
...
// ======================
// 根据类型获取字典详情
export const getSysDictionaryDetails = (data: DiceDetailReq): Promise<DiceDetail> => {
  return http.get('/v1/sys/dictionary/getSysDictionaryDetails', data);
};
